...
%% choose data
neuron = Sources2D();
nam = [tifname];          % this demo data is very small, here we just use it as an example
...
min_corr = 0.89;     % minimum local correlation for a seeding pixel decrease to .87?
